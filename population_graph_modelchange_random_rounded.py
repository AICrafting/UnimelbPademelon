...
while iterations > 0:
    ...
    x0 = format_list(round_element(pademelon_population), pademelon_list, 0, "pademelon")
    y0 = format_list(round_element(thylacine_population), thylacine_list, 0, "thylacine")
