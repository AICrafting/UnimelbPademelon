...
# Symbolises external events such as natural disasters
# that randomly affects the entire pademelon/thylacine population
...
while iterations > 0:
    ...
    x0 = format_list(round_element(pademelon_population), pademelon_list, random_max, "pademelon")
    y0 = format_list(round_element(thylacine_population), thylacine_list, random_max, "thylacine")
